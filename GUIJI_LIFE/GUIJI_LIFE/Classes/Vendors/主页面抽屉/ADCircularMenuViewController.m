...
#define STARTING_POINT CGPointMake(self.view.frame.size.width-36,self.view.frame.size.height-48)
...
-(void)setupData
{
    _fButtonSize = 60;//circular button width/height
    _fInnerRadius = 100;//1st circle boundary
}
...
- (void)setButtonFrames
{
    ...
    float incAngle = ( 117/3 )*M_PI/200.0 ;
    ...
    for (int i = 0; i < _iNumberOfButtons; i++)
    {
        ...
        else if(i == 7)//3rd circle
        {
            ...
            circleRadius = _fInnerRadius +(125*2);
        }
